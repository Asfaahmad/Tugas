...
public class LibrarySystem {
    ...
    public static void main(String[] args) {
        daftarBuku[i++] = new StoryBook("SB32F", "Laskar pelangi", 13, "Story", "Asfa");
        daftarBuku[i++] = new HistoryBook("HB324", "Kemerdekaan Indonesia", 2, "History", "Faris");
        daftarBuku[i++] = new TextBook("TB323", "Kalkulus", 4, "Text", "Hamidiy");

        // Mengisi daftar mahasiswa
        studentList.add(0, new Student("202310370311194", "Hamdan Hamidiy", "Teknik","Mesin"));
        studentList.add(1, new Student("202310370311203", "Asfa Ahmad", "Teknik","Informatika"));
        studentList.add(2, new Student("202310370311174", "Faris Ramadhan", "Teknik","Elektro"));
