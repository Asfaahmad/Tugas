...
import com.example.modultugas6.exception.LoginException;
...
public class LibrarySystemApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        label.setStyle("-fx-background-color: #BEBEBE;");

        ImageView imageView = new ImageView(new Image("https://images.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltceaa6cf20d328bd5/5eb7cdc1b1f2e27c950d2aaa/V_AGENTS_587x900_Jett.png"));
        imageView.setFitHeight(300);
        imageView.setFitWidth(200);

        Button studentButton = new Button("Login sebagai Mahasiswa");

        studentButton.setStyle("-fx-background-color: #BEBEBE;");
        ...
        VBox mainMenu = new VBox(10,label, studentButton,imageView, adminButton, exitButton);
        mainMenu.setAlignment(Pos.CENTER);
        Scene mainScene = new Scene(mainMenu, 500, 700);
    ...
    private void showStudentLogin(Stage stage) {
        ...
        loginButton.setOnAction(e -> {
            try {
                ...
                if (!found) {
                    throw new LoginException("NIM tidak ditemukan.");
                }
        ...
        Scene loginScene = new Scene(loginMenu, 500, 700);
    ...
    private void showStudentMenu(Stage stage, Student student) {
        ...
        Scene studentScene = new Scene(studentMenu, 500, 700);
    ...
    private void showReturnBook(Stage stage, Student student) {
        ...
        Scene returnBookScene = new Scene(returnBookLayout, 500, 700);
    ...
    private void showAdminMenu(Stage stage, Admin admin) {
        ...
        Scene adminScene = new Scene(adminMenu, 500, 700);
    ...
    private void showAddBookForm(Stage stage, Admin admin) {
        ...
        Scene addBookScene = new Scene(addBookForm, 500, 700);
    ...
    private void showAddStudentForm(Stage stage, Admin admin) {
        ...
        Scene addStudentScene = new Scene(addStudentForm, 500, 700);
