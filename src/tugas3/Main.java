...
public class Main {
    ...
    public static void main(String[] args) {
        // Stok buku
        daftarBuku.add(0, new Book("199d-e459-3794", "Laskar Pelangi", 4, "Novel" , "Andreas Hirata"));
        daftarBuku.add(1, new Book("po75-mb10-7juk", "Samantha", 7, "Novel", "Charless Duhigg"));
        daftarBuku.add(2, new Book("r65e-7c3a-1775", "The Power Of Habit", 3, "Novel", "Risa Saraswati"));
            ...
            switch (choice) {
                case 1:
                    ...
                    if (nimStudent.length() != 15) {
                        System.out.println("NIM tidak valid! Harus terdiri dari 15 karakter.");
                        break;
                    }
