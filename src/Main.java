...
class Student {
    ...
    void pinjamBuku(int j){
        Main main = new Main();
        Scanner scanString = new Scanner (System.in);
        System.out.println("Masukkan id buku yang ingin di pinjam (Ketik 99 untuk kembali)");
...
class Admin {
    ...
    public static String userx = "asfa";
    public static String passx = "ahmad";
    ...
    void displayStudent(){
        for (int j = 0; j < i; j++) { // menggunakan i untuk mengakses data sebanyak yang telah ditambahkan
...
public class Main {
    //data buku
    public static String[] idBuku = new String[] {"199d-e459-3794", "po75-mb10-7juk", "r65e-7c3a-1775"};
    public static String[] namaBuku = new String[] {"Samantha", "Laskar Pelangi", "The Power of Habit"};
    public static String[] author = new String[] {"Risa Saraswati", "Andrea Hirata", "Charles Duhigg"};
    public static String[] category = new String[] {"Horor", "Romance", "Self Improvement"};
    public static int[] stock = new int[] {6, 0, 2};
